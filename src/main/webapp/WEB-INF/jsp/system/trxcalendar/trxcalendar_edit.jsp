				...
				<div class="row">
					...
					<form action="trxcalendar/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">交易日:</td>
								<td>
								    <select class="chosen-select form-control" name="TRX_SYMBOL" id="TRX_SYMBOL" data-placeholder="请选择" style="width:49%;">
								    <option value="Y" <c:if test="${pd.TRX_SYMBOL == 'Y'}">selected</c:if>>是</option>
								    <option value="N" <c:if test="${pd.TRX_SYMBOL == 'N'}">selected</c:if>>否</option>
								    </select>
								</td>
							</tr>
							<tr>
