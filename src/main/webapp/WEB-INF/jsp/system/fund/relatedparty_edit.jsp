		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="fund/relatedparty/${msg}.do" name="Form" id="Form" method="post">
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:100px;text-align: right;padding-top: 13px;">基金ID:</td>
								<td><input type="text" readonly name="FUND_ID" id="FUND_ID" value="${pd.FUND_ID}" maxlength="100" title="基金ID" style="width:98%;"/></td>
								<td style="width:100px;text-align: right;padding-top: 13px;">关联方ID:</td>
								<td><input type="text" name="PARTY_ID" id="PARTY_ID" value="${pd.PARTY_ID}" maxlength="100" placeholder="这里输入关联方ID" title="关联方ID" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:100px;text-align: right;padding-top: 13px;">与本基金关系:</td>
								<td><input type="text" name="RELATIONSHIP" id="RELATIONSHIP" value="${pd.RELATIONSHIP}" maxlength="240" title="与本基金的关系" style="width:98%;"/></td>
							</tr>
							<tr>
