		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="fund/signoff/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="FUNDSIGNOFF_ID" id="FUNDSIGNOFF_ID" value="${pd.FUNDSIGNOFF_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">基金:</td>
								<td><input type="text" name="FUND_ID" id="FUND_ID" readonly value="${pd.FUND_ID}" maxlength="100" placeholder="这里输入基金" title="基金" style="width:98%;"/></td>
							</tr>
							<tr>
