		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="userfund/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
								...
								<table style="width:95%;" >
									...
									<tr>
										<td style="text-align: center;padding-top: 10px;">
											...
											<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/userfund/downExcel.do'">下载模版</a>
										</td>
									</tr>
								</table>
								</div>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$('#excel').ace_file_input({
				...
				//onchange:''
				maxsize:'100' // 限制文件大小为50GB（5242880000字节）
			});
		});
		...
		function fileType(obj) {  
			...
			reader.onload = function(e) {
				...
				if (signature !== 'd0cf11e0a1b11ae1' && signature !== '504b341406080002') { // 添加对较旧的BIFF5格式的xls文件的支持  
					$("#excel").tips({  
						side: 3,  
						msg: '请上传Excel格式的文件',  
						bg: '#AE82FF',  
