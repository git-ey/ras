		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="concmx/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="text" name="PARAM_CODE" id="PARAM_CODE" value="${pd.PARAM_CODE}" maxlength="60" placeholder="这里输入参数代码" title="参数代码" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">参数名称:</td>
								<td><input type="text" name="PARAM_NAME" id="PARAM_NAME" value="${pd.PARAM_NAME}" maxlength="120" placeholder="这里输入参数名称" title="参数名称" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="CONC_VALUE" id="CONC_VALUE" value="${pd.CONC_VALUE}" maxlength="255" placeholder="这里输入参数值" title="参数值" style="width:98%;"/></td>
							</tr>
							<tr>
