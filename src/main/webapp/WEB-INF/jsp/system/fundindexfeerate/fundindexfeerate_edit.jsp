		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="fundindexfeerate/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="FUNDINDEXFEERATE_ID" id="FUNDINDEXFEERATE_ID" value="${pd.FUNDINDEXFEERATE_ID}"/>
