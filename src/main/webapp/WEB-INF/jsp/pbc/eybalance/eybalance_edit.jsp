					...
					<form action="eybalance/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="APAR" id="APAR" value="${pd.APAR}" maxlength="20" placeholder="这里输入AR/AP" title="应收/应付" style="width:98%;"/></td>
								<td style="width:100px;text-align: right;padding-top: 13px;">币种:</td>
								<td><input type="text" name="CURRENCY" id="CURRENCY" value="${pd.CURRENCY}" maxlength="30" placeholder="代码，原币字段默认为CNY" title="币种" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:100px;text-align: right;padding-top: 13px;">汇率:</td>
								<td><input type="text" name="EXCHANGE_RATE" id="EXCHANGE_RATE" value="${pd.EXCHANGE_RATE}" maxlength="30" placeholder="CNY默认为1，其他币种填入科目" title="币种" style="width:98%;"/></td>
								<td style="width:100px;text-align: right;padding-top: 13px;">年初借贷方向:</td>
								<td><input type="text" name="BEGIN_DRCR" id="BEGIN_DRCR" value="${pd.BEGIN_DRCR}" maxlength="30" placeholder="借/贷/平" title="年初借贷方向" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:100px;text-align: right;padding-top: 13px;">年初本位币:</td>
								<td><input type="number" name="BEGIN_BALANCE_CNY" id="BEGIN_BALANCE_CNY" value="${pd.BEGIN_BALANCE_CNY}" maxlength="32" placeholder="余额表年初数" title="年初本位币" style="width:98%;"/></td>
								<td style="width:100px;text-align: right;padding-top: 13px;">本年本位币借方:</td>
								<td><input type="number" name="DR_AMOUNT_CNY" id="DR_AMOUNT_CNY" value="${pd.DR_AMOUNT_CNY}" maxlength="32" placeholder="余额表累计借方" title="本年本位币借方" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:100px;text-align: right;padding-top: 13px;">本年本位币贷方:</td>
								<td><input type="number" name="CR_AMOUNT_CNY" id="CR_AMOUNT_CNY" value="${pd.CR_AMOUNT_CNY}" maxlength="32" placeholder="余额表累计贷方" title="本年本位币贷方" style="width:98%;"/></td>
								<td style="width:100px;text-align: right;padding-top: 13px;">年末借贷方向:</td>
								<td><input type="text" name="END_DRCR" id="END_DRCR" value="${pd.END_DRCR}" maxlength="30" placeholder="借/贷/平" title="年末借贷方向" style="width:98%;"/></td>
							</tr>
							<tr>
