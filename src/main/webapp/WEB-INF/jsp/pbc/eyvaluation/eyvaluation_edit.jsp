				...
				<div class="row">
					...
					<form action="eyvaluation/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">估值日期:</td>
								<td><input class="span10 date-picker" name="VDATE" id="VDATE" value="${pd.VDATE}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="估值日期" title="估值日期" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">应收应付:</td>
								<td><input type="text" name="APAR" id="APAR" value="${pd.APAR}" maxlength="30" placeholder="这里输入应收应付" title="应收应付" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">汇率:</td>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">单位成本:</td>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">成本_原币:</td>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">成本_本位币:</td>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">行情收市价:</td>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">市值_原币:</td>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">市值_本位币:</td>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">估值增值_原币:</td>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">估值增值_本位币:</td>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">停牌信息:</td>
