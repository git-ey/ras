...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="dailysettlement/list.do" method="post" name="Form" id="Form">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">成交份额</th>
									<th class="center">成交金额</th>
									<th class="center">交易费用</th>
									<th class="center">后收费</th>
									<th class="center">确认金额</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.DEALER}</td>
											<td class='center'>${var.TRX_QUANTITY}</td>
											<td class='center'>${var.TRX_AMOUNT}</td>
											<td class='center'>${var.TRX_FEE}</td>
											<td class='center'>${var.BACKEND_FEE}</td>
											<td class='center'>${var.CONFIRMED_AMOUNT}</td>
	...
	<script type="text/javascript">
				...
				if(result) {
					...
					if(str==''){
						...
						if(msg == '确定要删除选中的数据吗?'){
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>dailysettlement/deleteAll.do?tm='+new Date().getTime(),
						    	data: {DATA_IDS:str},
								dataType:'json',
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>dailysettlement/excel.do';
		}
	</script>
