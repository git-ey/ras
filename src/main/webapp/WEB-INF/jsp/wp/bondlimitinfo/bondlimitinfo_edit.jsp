					...
					<form action="bondlimitinfo/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" autocomplete="off" name="MMF" id="MMF" value="${pd.MMF}" maxlength="10" title="货基" style="width:98%;"/></td>
								<td style="width:100px;text-align: right;padding-top: 13px;">科目代码:</td>
								<td><input type="text" autocomplete="off" name="ACCOUNT_NUM" id="ACCOUNT_NUM" value="${pd.ACCOUNT_NUM}" maxlength="255" title="科目代码" style="width:98%;"/></td>
							...
							<tr>
								...
								<td><input type="text" autocomplete="off" name="BOND_NAME" id="BOND_NAME" value="${pd.BOND_NAME}" maxlength="240" title="债券名称" style="width:98%;"/></td>
								...
								<td><input type="text" autocomplete="off" name="SUB_TYPE" id="SUB_TYPE" value="${pd.SUB_TYPE}" maxlength="30" title="子类型" style="width:98%;"/></td>
							</tr>
							<tr>
								...
								<td><input type="text" autocomplete="off" name="RESTRICT_TYPE" id="RESTRICT_TYPE" value="${pd.RESTRICT_TYPE}" maxlength="255" title="流通受限类型" style="width:98%;"/></td>
							...
							<tr>
								...
								<td><input type="number" autocomplete="off" name="RESMPATION_OPEN_PRICE" id="RESMPATION_OPEN_PRICE" value="${pd.RESMPATION_OPEN_PRICE}" maxlength="32" title="复牌开盘单价" style="width:98%;"/></td>
							</tr>
							<tr>
