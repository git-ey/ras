...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="eyje/list.do" method="post" name="Form" id="Form">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">借贷方向</th>
									<th class="center">原币金额</th>
									<th class="center">本位币金额</th>
									<th class="center">借正贷负金额</th>
									<th class="center">数量</th>
									<th class="center">摘要</th>
									<th class="center">制单人</th>
									<th class="center">审核人</th>
									<th class="center">记账人</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.DRCR}</td>
											<td class='center'>${var.AMOUNT_ENTERED}</td>
											<td class='center'>${var.AMOUNT_CNY}</td>
											<td class='center'>${var.AMOUNT_CNY_DRCR}</td>
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>eyje/goAdd.do';
			 diag.Width = 800;
			 diag.Height = 450;
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>eyje/goEdit.do?EYJE_ID='+Id;
			 diag.Width = 800;
			 diag.Height = 450;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
				...
				if(result) {
					...
					if(str==''){
						...
						if(msg == '确定要删除选中的数据吗?'){
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>eyje/deleteAll.do?tm='+new Date().getTime(),
						    	data: {DATA_IDS:str},
								dataType:'json',
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>eyje/excel.do';
		}
	</script>
