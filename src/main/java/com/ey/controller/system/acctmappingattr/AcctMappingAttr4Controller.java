 ...
 */
@Controller
@RequestMapping(value="/acctmappingattr4")
public class AcctMappingAttr4Controller extends BaseController {
	...
	public void delete(PrintWriter out) throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		acctmappingattr4Service.delete(pd);
		out.write("success");
		out.close();
	}
	...
	public ModelAndView edit() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		acctmappingattr4Service.edit(pd);
		mv.addObject("msg","success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView list(Page page) throws Exception{
		...
		page.setPd(pd);
		List<PageData>	varList = acctmappingattr4Service.list(page);	//列出AcctMappingAttr1列表
		mv.setViewName("system/acctmappingattr/acctmappingattr4_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("system/acctmappingattr/acctmappingattr4_edit");
	...
	public ModelAndView goEdit()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = acctmappingattr4Service.findById(pd);	//根据ID读取
		mv.setViewName("system/acctmappingattr/acctmappingattr4_edit");
	...
	public Object deleteAll() throws Exception{
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			acctmappingattr4Service.deleteAll(ArrayDATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
	...
	public ModelAndView exportExcel() throws Exception{
		...
		List<PageData> varOList = acctmappingattr4Service.listAll(pd);
