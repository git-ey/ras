 ...
 */
@Controller
@RequestMapping(value="/fund/trxrule")
public class TrxRuleController extends BaseController {
	
	String menuUrl = "fund/trxrule/list.do"; //菜单地址(权限用)
	@Resource(name="fundtrxruleService")
	private TrxRuleManager fundtrxruleService;
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("system/fund/trxrule_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		mv.setViewName("system/fund/trxrule_edit");
