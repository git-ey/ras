...
import com.ey.service.system.fund.StructuredManager;
 ...
 */
@Controller
@RequestMapping(value="/fund/structured")
public class StructuredController extends BaseController {
	
	String menuUrl = "fund/structured/list.do"; //菜单地址(权限用)
	@Resource(name="fundstructuredService")
	private StructuredManager fundstructuredService;
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("system/fund/structured_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("system/fund/structured_edit");
