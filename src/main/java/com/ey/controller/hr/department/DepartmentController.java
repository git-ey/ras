package com.ey.controller.hr.department;
...
public class DepartmentController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("hr/department/department_list");
	...
	public ModelAndView listAllDepartment(Model model,String DEPARTMENT_ID)throws Exception{
		...
		try{
			...
			mv.addObject("pd", pd);	
			mv.setViewName("hr/department/department_ztree");
		} catch(Exception e){
	...
	public ModelAndView goAdd()throws Exception{
		...
		mv.setViewName("hr/department/department_edit");
