package com.ey.controller.db.timingbackup;
...
import com.ey.service.db.brdb.impl.BRdbService;
import com.ey.service.db.timingbackup.impl.TimingBackUpService;
...
public class DbBackupQuartzJob extends BaseController implements Job{
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			String kackupPath = DbTools.getDbFH().backup(TABLENAME).toString();//调用数据库备份
