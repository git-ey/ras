package com.ey.controller.db.brdb;
...
public class BRdbController extends BaseController {
	...
	public ModelAndView listAllTable() throws Exception{
		...
		Object[] arrOb = DbTools.getTables();
	...
	public Object backupAll(){
		...
		String kackupPath;
		try {
			kackupPath = DbTools.getDbFH().backup("").toString();		//调用数据库备份
	...
	public Object dbRecover(){
		...
		try {
			String returnStr = DbTools.getDbFH().recover(TABLENAME, SQLPATH).toString();
	...
	public ModelAndView list(Page page) throws Exception{
		...
		Map<String,String> DBmap = DbTools.getDBParameter();
