    ...
    public void saveBatch(List<Map> maps) throws Exception {
		...
		for (Map<String, Object> map : maps) {
			if (null != map.get("PERIOD")) {
				...
				pd.put("INTEREST_MODE", "INTEREST_MODE");
				pd.put("PAYMENT_METHOD", "PAYMENT_METHOD");
				pd.put("PAYMENT_TIMES_YEAR", "PAYMENT_TIMES_YEAR");
				pd.put("INTEREST_PAY_METHOD", "INTEREST_PAY_METHOD");
				pd.put("PAY_DATE_YEAR", "PAY_DATE_YEAR");
				pd.put("PAY_DATE_LAST", "PAY_DATE_LAST");
				pd.put("PAY_DATE_NEXT", "PAY_DATE_NEXT");
				pd.put("BOND_RATING", "BOND_RATING");
				pd.put("BOND_RATING_ORG", "BOND_RATING_ORG");
				pd.put("BOND_RATING_DATE", "BOND_RATING_DATE");
				pd.put("ENTITY_RATING", "ENTITY_RATING");
				pd.put("ENTITY_RATING_ORG", "ENTITY_RATING_ORG");
				pd.put("ENTITY_RATING_DATE", "ENTITY_RATING_DATE");
				pd.put("TAX_FREE", "TAX_FREE");
				pd.put("TAX_RATE", "TAX_RATE");
				pd.put("SPECIAL_CLAUSE", "SPECIAL_CLAUSE");
				pd.put("EARLY_EXERCISE", "EARLY_EXERCISE");
				pd.put("YEAR_N", "YEAR_N");
				pd.put("INTEREST_RATE_OPTION", "INTEREST_RATE_OPTION");
				pd.put("SELL_BACK", "SELL_BACK");
				pd.put("REDEMPTION", "REDEMPTION");
				pds.add(pd);
				idx++;
			}
