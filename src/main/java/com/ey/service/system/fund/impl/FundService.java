...
public class FundService implements FundManager{
    ...
    public void saveBatch(List<Map> maps) throws Exception {
		...
		for (Map<String, Object> map : maps) {
			...
			pd.put("INT_SEN_METHOD",map.get("INT_SEN_METHOD"));
			pd.put("INT_SEN_SOURCE_TYPE",map.get("INT_SEN_SOURCE_TYPE"));
			pd.put("INT_SEN_ASSET_EXCL",map.get("INT_SEN_ASSET_EXCL"));
			pd.put("INT_VAR",map.get("INT_VAR"));
			pd.put("PRI_SEN_METHOD",map.get("PRI_SEN_METHOD"));
			pd.put("PRI_SEN_SOURCE_TYPE",map.get("PRI_SEN_SOURCE_TYPE"));
			pd.put("PRI_VAR",map.get("PRI_VAR"));
			pd.put("PRI_SEN_ASSET",map.get("PRI_SEN_ASSET"));
