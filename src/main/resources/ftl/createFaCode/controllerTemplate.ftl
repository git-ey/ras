package com.ey.controller.${packageName}.${objectNameLower};
...
import com.ey.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.ey.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
