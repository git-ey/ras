...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="V500">
  <Table x:FullColumns="1" x:FullRows="1" ss:StyleID="s74" ss:DefaultColumnWidth="55.5" ss:DefaultRowHeight="13.5">
   ...
   <Row/>
   <Row/>
   <#if extraFundInfo.newFundFlag == 'Y'>
   <#if V600.delta.otherPriceSumData.flag = 'Y' || V600.delta.otherPriceSumData.flagLast = 'Y'>
   <Row ss:AutoFitHeight="0" ss:Height="31.8">
    <Cell ss:MergeAcross="13" ss:StyleID="s69"><Data ss:Type="String">其他价格风险是指资产管理计划所持金融工具的公允价值或未来现金流量因除市场利率和外汇汇率以外的市场价格因素变动而发生波动的风险。本资产管理计划所面临的其他价格风险来源于单个证券发行主体自身经营情况或特殊事项的影响，也可能来源于证券市场整体波动的影响。</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="31.8">
    <Cell ss:MergeAcross="13" ss:StyleID="s69"><Data ss:Type="String">本资产管理计划的管理人定期结合宏观及微观环境的变化，对投资策略、资产配置、投资组合进行修正，来主动应对可能发生的市场价格风险。此外，本资产管理计划的管理人每日对本资产管理计划所持有的证券价格实施监控，定期运用多种定量方法对基金进行风险度量，及时对风险进行跟踪和控制。于本期末及上期末，本资产管理计划的其他价格风险敞口为交易性金融资产的账面价值。</Data></Cell>
   </Row>
   <#if V600.delta.otherPriceSumData.flag = 'Y'>
   <Row>
    <Cell ss:StyleID="s69"/>
    <Cell><Data ss:Type="String">于本期末，在所有其他变量保持不变的假设下，如果相应交易性金融资产的公允价值上涨/下跌5%，本资产管理计划的资产净值会由于以公允价值计量且其变动计入当期损益的金融工具公允价值的变化而增加/减少人民币${(V600.delta.otherPriceSumData.mkValue)?string(',##0.00')}元</Data></Cell>
   </Row>
   <#else>
   <Row>
    <Cell ss:StyleID="s69"/>
    <Cell><Data ss:Type="String">本期末，市场利率的变动对本资产管理计划的资产净值无重大影响</Data></Cell>
   </Row>
   </#if>
   <#if V600.delta.otherPriceSumData.flagLast = 'Y'>
   <#if V600.delta.otherPriceSumData.flag = 'Y'>
   <Row>
    <Cell ss:StyleID="s69"/>
    <Cell><Data ss:Type="String">（上期末：交易性金融资产的公允价值上涨/下跌5%，本资产管理计划的资产净值增加/减少人民币${(V600.delta.otherPriceSumData.mkValueLast)?string(',##0.00')}元）。</Data></Cell>
   </Row>
   <#else>
   <Row>
    <Cell ss:StyleID="s69"/>
    <Cell><Data ss:Type="String">（上期末：在所有其他变量保持不变的假设下，如果相应交易性金融资产的公允价值上涨/下跌5%，本资产管理计划的资产净值会由于以公允价值计量且其变动计入当期损益的金融工具公允价值的变化而增加/减少人民币${(V600.delta.otherPriceSumData.mkValueLast)?string(',##0.00')}元）。</Data></Cell>
   </Row>
   </#if>
   <#else>
   <Row>
    <Cell ss:StyleID="s69"/>
    <Cell><Data ss:Type="String">（上期末，市场利率的变动对本资产管理计划的资产净值无重大影响）。</Data></Cell>
   </Row>
   </#if>
   <#else>
   <Row>
    <Cell ss:StyleID="s69"/>
    <Cell><Data ss:Type="String">其他价格风险是指资产管理计划所持金融工具的公允价值或未来现金流量因除市场利率和外汇汇率以外的市场价格因素变动而发生波动的风险。本资产管理计划主要投资于具有良好流动性的固定收益类金融工具，因此无重大其他价格风险。</Data></Cell>
   </Row>
   </#if>
   <#else>
   <#if V600.delta.otherPriceSumData.flag = 'Y'>
   <Row>
    <Cell ss:StyleID="s69"/>
    <Cell><Data ss:Type="String">其他价格风险是指资产管理计划所持金融工具的公允价值或未来现金流量因除市场利率和外汇汇率以外的市场价格因素变动而发生波动的风险。本资产管理计划所面临的其他价格风险来源于单个证券发行主体自身经营情况或特殊事项的影响，也可能来源于证券市场整体波动的影响。</Data></Cell>
   </Row>
   <Row>
    <Cell ss:StyleID="s69"/>
    <Cell><Data ss:Type="String">本资产管理计划的管理人定期结合宏观及微观环境的变化，对投资策略、资产配置、投资组合进行修正，来主动应对可能发生的市场价格风险。此外，本资产管理计划的管理人每日对本资产管理计划所持有的证券价格实施监控，定期运用多种定量方法对基金进行风险度量，及时对风险进行跟踪和控制。于本期末，本资产管理计划的其他价格风险敞口为交易性金融资产的账面价值。本资产管理计划严格按照资产管理合同中对投资组合比例的要求进行资产配置，通过投资组合的分散化降低其他价格风险。此外，管理人密切对本资产管理计划所持有的证券价格实施监控，定期运用多种定量方法对资产管理计划进行风险度量，及时可靠地对风险进行跟踪和控制。于本期末，在所有其他变量保持不变的假设下，如果相应交易性金融资产的公允价值上涨/下跌5%，本资产管理计划的资产净值会由于以公允价值计量且其变动计入当期损益的金融工具公允价值的变化而增加/减少人民币${(V600.delta.otherPriceSumData.mkValue)?string(',##0.00')}元。</Data></Cell>
   </Row>
   <#else>
   <Row>
    <Cell ss:StyleID="s69"/>
    <Cell><Data ss:Type="String">其他价格风险是指资产管理计划所持金融工具的公允价值或未来现金流量因除市场利率和外汇汇率以外的市场价格因素变动而发生波动的风险。本资产管理计划投资于具有良好流动性的固定收益类金融工具，因此无重大其他价格风险。</Data></Cell>
   </Row>
   </#if>
   </#if>
  </Table>
