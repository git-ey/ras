 ...
 <Worksheet ss:Name="V500">
  <Table x:FullColumns="1" x:FullRows="1" ss:StyleID="s74" ss:DefaultColumnWidth="55.5" ss:DefaultRowHeight="13.5">
   ...
   <Row>
    <Cell ss:StyleID="s43"/>
    <#if item_index == 0>
    <Cell ss:MergeDown="${(V500.hypothesisCount-1)?string('0')}" ss:StyleID="s358"><Data ss:Type="String">假设</Data></Cell>
    <Cell ss:MergeAcross="2" ss:StyleID="s356"><Data ss:Type="String">${item!}</Data></Cell>
    <#else>
    <Cell ss:Index="3" ss:MergeAcross="2" ss:StyleID="s356"><Data ss:Type="String">${item!}</Data></Cell>
    </#if>
 ...
 <Worksheet ss:Name="V500">
  <Table x:FullColumns="1"
   ...
   <Row ss:StyleID="s262">
    ...
    <Cell ss:StyleID="s267" ss:Formula="=SUM(R[${(-1-V500.betaCount)?string('0')}]C:R[-1]C)"><Data ss:Type="Number"></Data></Cell>
    <Cell ss:StyleID="s267"/>
    <Cell ss:StyleID="s159"><Data ss:Type="String">组合beta</Data></Cell>
    <Cell ss:StyleID="s268" ss:Formula="=SUM(R[${(-1-V500.betaCount)?string('0')}]C:R[-1]C)"><Data ss:Type="Number"></Data></Cell>
   </Row>
   <Row>
